      ...
      body: PageView(
        ...
        children: <Widget>[
          makePage(
            ...
            description: 'Creamos jabónes artesanales de la mejor calidad para tu hogar.'
          ),
          makePage(
            page: 2,
            image: 'assets/images/two.jpg',
            title: 'Shampoo Sólido',
            description: 'Los mejores shampoos sólidos para el crecimient de tu cabello.'
          ),
          makePage(
            page: 3,
            image: 'assets/images/three.jpg',
            title: 'Balsamos naturales',
            description: "Solo lo mejor para la hidratación y humectación de tus labios"
          ),
          makePage(
            page: 4,
            image: 'assets/images/four.jpg',
            title: 'Maquillaje artesanal',
            description: "Maquillaje para"
          ),
        ],
      ),
    );
